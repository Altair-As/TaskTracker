    ...
    public partial class InitializeDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProcess", x => new { x.EmployeesId, x.ProcessesId });
                    table.ForeignKey(
                        name: "FK_EmployeeProcess_Employees_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProcess_Processes_ProcessesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProcess_ProcessesId",
